...
#    ✅ 个股评分（-100， 100）: 0.0, 第5186个，总共：5190个, code:601112.SH
#❌ 评估条件 '区间涨停次数' 时出错: division by zero
#Traceback (most recent call last):
#  File "F:\myFile\MyProject\Stock\MyStockTest\src\main_code\Core\Select\ConditionEvaluator.py", line 215, in _evaluate_condition
#    data = self.main.calculationDataHandle.GetWindowDataClass(self.stock_code, todayStr, condition.dateFrom, condition.dateTo)
#  File "F:\myFile\MyProject\Stock\MyStockTest\src\main_code\Core\Calculate\CalculationDataHandle.py", line 714, in GetWindowDataClass
#    windowsClass.avg_volume_rito = CalculationUtil.Get_VolumeRatio_5_Window_Avg(startDataClass, startDateCount, toDateCount, self)
#                                   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#  File "F:\myFile\MyProject\Stock\MyStockTest\src\main_code\Core\Calculate\CalculationUtil.py", line 1252, in Get_VolumeRatio_5_Window_Avg
#    volume_Ratio_5 = GetVolume_5(single)
#  File "F:\myFile\MyProject\Stock\MyStockTest\src\main_code\Core\Calculate\CalculationUtil.py", line 207, in GetVolume_5
#    total = total / target_num
#            ~~~~~~^~~~~~~~~~~~
#ZeroDivisionError: division by zero

#❌ 评估节点失败: division by zero
#❌ 评估条件树时出错: division by zero
#❌ 评估因子 '条件列表' 时出错: division by zero
#✅ 个股评分（-100， 100）: 0.0, 第5187个，总共：5190个, code:688712.SH
#❌ 评估条件 '区间涨停次数' 时出错: division by zero
#Traceback (most recent call last):
#  File "F:\myFile\MyProject\Stock\MyStockTest\src\main_code\Core\Select\ConditionEvaluator.py", line 215, in _evaluate_condition
#    data = self.main.calculationDataHandle.GetWindowDataClass(self.stock_code, todayStr, condition.dateFrom, condition.dateTo)
#  File "F:\myFile\MyProject\Stock\MyStockTest\src\main_code\Core\Calculate\CalculationDataHandle.py", line 682, in GetWindowDataClass
#    windowsClass.change_Ratio = CalculationUtil.GetChange_Ratio_Window(startDataClass, startDateCount, toDateCount)
#                                ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#  File "F:\myFile\MyProject\Stock\MyStockTest\src\main_code\Core\Calculate\CalculationUtil.py", line 970, in GetChange_Ratio_Window
...
#❌ 评估条件树时出错: division by zero
#❌ 评估因子 '条件列表' 时出错: division by zero
#✅ 个股评分（-100， 100）: 0.0, 第5188个，总共：5190个, code:603284.SH
#❌ 评估条件 '区间涨停次数' 时出错: division by zero
#Traceback (most recent call last):
#  File "F:\myFile\MyProject\Stock\MyStockTest\src\main_code\Core\Select\ConditionEvaluator.py", line 215, in _evaluate_condition
#    data = self.main.calculationDataHandle.GetWindowDataClass(self.stock_code, todayStr, condition.dateFrom, condition.dateTo)
...
#❌ 评估条件树时出错: division by zero
#❌ 评估因子 '条件列表' 时出错: division by zero
#✅ 个股评分（-100， 100）: 0.0, 第5189个，总共：5190个, code:688818.SH
#❌ 评估条件 '区间涨停次数' 时出错: division by zero
#Traceback (most recent call last):
#  File "F:\myFile\MyProject\Stock\MyStockTest\src\main_code\Core\Select\ConditionEvaluator.py", line 215, in _evaluate_condition
#    data = self.main.calculationDataHandle.GetWindowDataClass(self.stock_code, todayStr, condition.dateFrom, condition.dateTo)
...
#❌ 评估条件树时出错: division by zero
#❌ 评估因子 '条件列表' 时出错: division by zero
#✅ 个股评分（-100， 100）: 0.0, 第5190个，总共：5190个, code:688816.SH